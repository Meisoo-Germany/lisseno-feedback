...
**This repository is for bug reports and feature requests** — the app itself is closed-source.

- 🐛 Found a bug? [Open an issue](../../issues/new) — please include your macOS version and which app you were translating.
- 💡 Feature request? [Open an issue](../../issues/new) and describe your use case.
- 📖 How to use Lisseno in Zoom, Teams & Google Meet: [lisseno.com/guide](https://lisseno.com/guide)
- ✉️ Anything private: hello@lisseno.com
